"""
Catering Terms & Conditions ("Service Information") shown before an order
can be confirmed. Ported verbatim from Tablet/utils/terms.py — do not edit
old accepted text in place; bump CURRENT_TERMS_VERSION instead so historical
orders keep the exact version they agreed to.
"""
...
# Post-event customer evaluation survey — captured in the source document but
# not wired into any screen yet in either the original app or this rewrite.
# Kept here, unused, for a future "Evaluation Survey" feature.
